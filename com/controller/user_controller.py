...
def insert_user():
    try:
        ...
        print(login_username, user_firstname, user_lastname, user_gender, user_address, user_contact)
        ...
        sender = "python.innoventa@gmail.com"
        ...
        server.starttls()
        server.login(sender, "admin@12345")
        text = msg.as_string()
